...
class Ct_Devsoul_Psbsp_Admin {
	...
	public function devsoul_psbsp_add_submenu() {
		...
		add_submenu_page(
			...
			esc_html__('Sales Report Pro', 'cloud_tech_psbsp '), // Title.
	...
	public function ct_psbsp_tab_callback() {
		...
		<div class="wrap woocommerce">
			...
			<nav class="nav-tab-wrapper woo-nav-tab-wrapper">
				...
				<a href="<?php echo esc_url(admin_url('admin.php?page=devsoul_psbsp_setting&tab=general_setting')); ?>"
					class="nav-tab  <?php echo esc_attr($active_tab) === 'general_setting' ? ' nav-tab-active' : ''; ?>">
					<?php esc_html_e('General Settings', 'country_selector'); ?> </a>
				...
				<a href="<?php echo esc_url(admin_url('admin.php?page=devsoul_psbsp_setting&tab=sales_by_product&section=all_prd')); ?>"
					...
					<?php esc_html_e('Products Sales', 'country_selector'); ?> </a>
				<a href="<?php echo esc_url(admin_url('admin.php?page=devsoul_psbsp_setting&tab=sales_by_order&section=all_order')); ?>"
					...
					<?php esc_html_e('Order Sales', 'country_selector'); ?> </a>
			</nav>
			...
			<form method="post"
				...
				if ('general_setting' === $active_tab) {
					settings_fields('devsoul_psbsp_general_settings_fields');
					do_settings_sections('devsoul_psbsp_general_settings_sections');
					submit_button();
				}
				?>
			</form>
