...
<style>
	...
	.second-template table tr td:nth-child(5), .second-template table tr td:nth-child(6),
	...
	.second-template .af-rfq-rent-period h3, .second-template .af-rfq-profile-checkout h3{
		font-weight: 700;
		color: #000;
	...
	<form method="post" enctype="multipart/form-data" >
		...
		<section class="af-rfq-custom-form">
			<div class="container">
				...
				<input type="submit" name="palce_quote" class="second-template-btn palce_quote button primary-button" value="<?php echo esc_attr (get_option('ct_rfq_place_quote_button_text') ? get_option('ct_rfq_place_quote_button_text') : 'Place Quote'); ?>" >
			</div>
		</section>
	</form>
	<?php
