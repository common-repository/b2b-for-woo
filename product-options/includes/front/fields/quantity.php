...
class="ck_quantity <?php echo esc_attr($front_dep_class); ?>" 
...
<?php endif ?>
data-price_type="<?php echo esc_attr($price_type . '_quantity'); ?>" 
data-price="<?php echo esc_attr($price); ?>"
data-heading = <?php echo esc_attr(get_post_meta($field_id, 'ck_field_title', true)); ?>
