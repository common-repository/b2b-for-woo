 ...
 *  Product Fields 
 */
class Product_Options_Product_Fields {

	public static function ck_product_level_fields( $prod_id) {
				...
				<div class="field_div">
					...
					<div class="prod_optn_remove_field_btn_main_div display_flex <?php echo esc_attr($field_id); ?>_prod_optn_remove_field_btn_main_div">
						...
						<div class="prod_optn_remove_field_btn_div">
							...
							<input type="number" name="ck_field_priority[<?php echo esc_attr($field_id); ?>]" style="height: 40px; width: 30%; vertical-align: top; float: revert;" placeholder="Field Priority" value="<?php echo esc_attr($field_priority); ?>">
							...
							<button class="field_close_btn <?php echo esc_attr($field_id); ?>_field_close_btn" title="Close Field" data-field_id="<?php echo esc_attr($field_id); ?>" data-type="product"> 
								...
								<tbody>
									...
									foreach ( $option_idss as $option_id ) {
										...
										<tr class="prod_optn_option_tr" data-field_id="<?php echo esc_attr($field_id); ?>" data-option_id="<?php echo esc_attr($option_id); ?>">
											...
											<td>
												<input type="number" name="ck_option_priority[<?php echo esc_attr($field_id); ?>][<?php echo esc_attr($option_id); ?>]" class="ck_option_priority" value="<?php echo esc_attr($option_priority); ?>" placeholder="Option Priority">
											</td>
...
new Product_Options_Product_Fields();
