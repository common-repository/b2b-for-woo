...
/**
 * Rule Level Option's Ajax Controller.
 */
class Product_Options_Ajax_Fields {

	public static function ajax_product_field_template( $field_id, $post_parent_id ) {

		$field_ids = Prd_General_Functions::get_posts_ids_of_current_post('Product_add_field', $post_parent_id);
		...
		<div class="field_div">
			...
			<div class="prod_optn_remove_field_btn_main_div display_flex <?php echo esc_attr($field_id); ?>_prod_optn_remove_field_btn_main_div">
				...
				<div class="prod_optn_remove_field_btn_div">
					...
					<input type="hidden" name="prod_optn_rule_id" class="prod_optn_rule_id" value="<?php echo esc_attr($post_parent_id); ?>">

					<input type="number" name="ck_field_priority[<?php echo esc_attr($field_id); ?>]" style="height: 40px; width: 30%; vertical-align: top; float: revert;" placeholder="Field Priority">

					<button class="field_dlte_btn" title="Remove Field" data-field_id="<?php echo esc_attr($field_id); ?>" data-type="product">
						...
						<tbody>
							...
							foreach ( $option_idss as $option_id ) {
								...
								<tr class="prod_optn_option_tr" data-field_id="<?php echo esc_attr($field_id); ?>" data-option_id="<?php echo esc_attr($option_id); ?>">
									...
									<td>
										<select name="ck_option_price_type[<?php echo esc_attr($field_id); ?>][<?php echo esc_attr($option_id); ?>]" class="ck_option_price_type" style="width: 50%;">
										...
										<input type="number" name="ck_option_price[<?php echo esc_attr($field_id); ?>][<?php echo esc_attr($option_id); ?>]" class="ck_option_price" value="<?php echo esc_attr($option_price); ?>" placeholder="Option Price" min="1">
									</td>
			...
			<div class="prod_opt_add_optn_btn_div <?php echo esc_attr($field_id); ?>_prod_opt_add_optn_btn_div">
				...
				<button class="option_add_btn" title="Add Option" data-parent_id="<?php echo esc_attr($field_id); ?>" data-type="product">
	...
	public static function ajax_product_row_template( $option_id, $field_id ) {
		...
		<tr class="prod_optn_option_tr" data-field_id="<?php echo esc_attr($field_id); ?>" data-option_id="<?php echo esc_attr($option_id); ?>">
			...
			<td>
				<select name="ck_option_price_type[<?php echo esc_attr($field_id); ?>][<?php echo esc_attr($option_id); ?>]" class="ck_option_price_type" style="width: 50% !important;">
				...
				<input type="number" name="ck_option_price[<?php echo esc_attr($field_id); ?>][<?php echo esc_attr($option_id); ?>]" class="ck_option_price" value="<?php echo esc_attr($option_price); ?>" placeholder="Option Price" style="width: 50% !important;" min="1">
			</td>
	...
	public static function ajax_variation_field_template( $field_id, $prod_id ) {
			...
			<div class="display_flex prod_opt_field_price_main_div <?php echo esc_attr($field_id); ?>_prod_opt_field_price_main_div">
				...
				<div style="width: 100%; float: left; margin: 5px">
					...
					<div class="prod_opt_field_price_type_price_div <?php echo esc_attr($field_id); ?>_prod_opt_field_price_type_price_div">
						...
						<input type="text" name="ck_field_price[<?php echo esc_attr($field_id); ?>]" value="<?php echo esc_attr($field_price); ?>" class="ck_field_price <?php echo esc_attr($field_id); ?>_ck_field_price" placeholder="Field Price" min="1">
			...
			<div class="display_flex prod_opt_limit_range_main_div <?php echo esc_attr($field_id); ?>_prod_opt_limit_range_main_div">
				...
				<div style="width: 100%; float: left; margin: 5px">
					...
					<div class="prod_opt_field_limit_to_div <?php echo esc_attr($field_id); ?>_prod_opt_field_limit_to_div">
						...
						<input type="number" name="ck_field_min_limit[<?php echo esc_attr($field_id); ?>]" value="<?php echo esc_attr($field_min_limit); ?>" class="ck_field_min_limit <?php echo esc_attr($field_id); ?>_ck_field_min_limit" placeholder="Minimum Limit" style="float: none; height: 40px; width: 48% !important;" min="1">

						<span><?php echo esc_html('to'); ?></span>

						<input type="number" name="ck_field_max_limit[<?php echo esc_attr($field_id); ?>]" value="<?php echo esc_attr($field_max_limit); ?>" class="ck_field_max_limit <?php echo esc_attr($field_id); ?>_ck_field_max_limit" placeholder="Maximum Limit" style="float: none; height: 40px; width: 48% !important;" min="1">
							...
							foreach ( $option_idss as $option_id ) {
								...
								<tr class="prod_optn_option_tr" data-field_id="<?php echo esc_attr($field_id); ?>" data-option_id="<?php echo esc_attr($option_id); ?>">
									...
									<td>
										...
										<input type="number" name="ck_option_price[<?php echo esc_attr($field_id); ?>][<?php echo esc_attr($option_id); ?>]" value="<?php echo esc_attr($option_price); ?>" placeholder="Option Price" style="width: 48% !important;height: 40px; float: right !important; min-width: unset !important;" min="1">
									</td>

									<td>
										<input type="number" name="ck_option_priority[<?php echo esc_attr($field_id); ?>][<?php echo esc_attr($option_id); ?>]" class="ck_option_priority" value="<?php echo esc_attr($option_priority); ?>" placeholder="Option Priority" style="float: right;" min="0">
									</td>
	...
	public static function ajax_variation_row_template( $option_id, $field_id ) {
	...
	public static function ajax_rule_field_template( $field_id, $post_parent_id ) {
		...
		<div class="field_div">
			...
			<div class="prod_optn_remove_field_btn_main_div display_flex <?php echo esc_attr($field_id); ?>_prod_optn_remove_field_btn_main_div">
				...
				<div class="prod_optn_remove_field_btn_div">
					...
					<input type="number" name="ck_field_priority[<?php echo esc_attr($field_id); ?>]" style="height: 40px; width: 30%; vertical-align: bottom;" min="0" placeholder="Field Priority" value="<?php echo esc_attr($field_priority); ?>" min="0">
	...
	public static function ajax_rule_row_template( $option_id, $field_id ) {
...
new Product_Options_Ajax_Fields();
